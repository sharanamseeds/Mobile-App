...
import { ADDOFFER, REMOVECARTITEM, REMOVEOFFER } from "../../redux/cart/CartSlice";
                    ...
                    >
                      <View style={{ ...styles.offerDetail }}>
                        ...
                        <ThemedText style={{ marginLeft: 5 }}>
                          {item?.offers?.find((f) => f._id === item?.selectedOffer)?.offer_name}
                        </ThemedText>
                      </View>
                      <View
                        style={{
